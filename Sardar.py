...
\033[1;91m [⚡\033[1;97mAuthor Name: S9RD9R-BR9ND-420   ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mFacbook.com: Sardarinsidiiw ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Bangladesh    ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mSardar brand\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mSardar brand\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "SARDAR-BRAND"
CorrectPassword = "SANA-X-DANISH"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('https://www.facebook.com/sardarinsidiiw?mibextid=ZbWKwL')
    else:
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://youtube.com/@S9RD9RTRIICK3R3M')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mDanish\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
